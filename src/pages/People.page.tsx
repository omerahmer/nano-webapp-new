...
const people: PeopleData[] = [
  {
    ...
    teams: 'Design',
    blurb:
      'I fabricate chips with CNTs and optimize the performancie of the CNT-based devices we create. Additionally, I mentor and guide students within the research team on microfabrication, electronics, theoretical analysis and experimental methodology.',
  },
  {
    name: 'Mateusz Czajka',
    image:
      '<a href="https://ibb.co/2M08jZh"><img src="https://i.ibb.co/KscN9Kh/happymatty-min.jpg" alt="happymatty-min" border="0" /></a>',
  ...
  {
    name: 'Waqas Khalid',
    image: `<a href="https://ibb.co/hs9zvLC"><img src="https://i.ibb.co/F63Ttmn/waqas.jpg" alt="waqas" border="0"></a>`,
  ...
  },
  {
    ...
    teams: 'Biosensing',
    blurb:
      'Run functionalization quantization procedure to determine the concentration through a low-pass filter by measuring the impedance.',
  },
  {
  ...
  },
  {
    ...
    image:
      '<a href="https://ibb.co/dB1Vjsg"><img src="https://i.ibb.co/VVrzJ0m/Shankar-pic.jpg" alt="Shankar-pic" border="0"></a>',
    teams: 'Energy Storage',
    blurb:
  ...
  },
  {
    ...
    blurb:
      "I am currently working on the design team to develop an effective mold for safe removal after fabrication. Additionally, I'm working on market analysis for the E-Beam Lithography project.",
  },
  {
    name: 'Vedant Agarwal',
    image: '',
