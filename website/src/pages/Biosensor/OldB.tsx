...
export default function OldB() {
  ...
  const experiment_config = (
    <div className="overflow-hidden" style={{ display: 'inline-block' }}>
      <div
        className="container"
        style={{ border: '', display: 'flex', flexWrap: 'wrap', width: '100%' }}
      >
        {/* Table div */}
        ...
        <div
          ...
          style={{ display: 'flex', flexWrap: 'wrap', border: '', padding: '5px', width: '50%' }}
        >
  ...
  return (
    <div className="bg-white">
      <div className="text-center">
        ...
        <div className="">{!experimentIsRunning ? experiment_config : experiment_dashboard}</div>
      </div>
    </div>
  );
}
