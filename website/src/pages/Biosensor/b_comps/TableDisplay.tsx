          ...
          <table className="custom-table">
            <thead>
              <tr className="bg-gray-200 border-b-2 border-gray-300">
                ...
                <th className="p-1 text-center text-xl font-semibold">Calculation Configuration</th>
                <th className="p-1 text-center text-xl font-semibold">Result</th>
              </tr>
            </thead>
            <tbody>
                ...
                if (data[key] === 'header') {
                  return (
                    <tr key={key} className="header-row">
                      <td colSpan={1} className="py-2 font-bold text-left">
                        {textCamelToSpace(key)}
                      </td>
                    </tr>
                  );
                }
