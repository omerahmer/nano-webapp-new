...
const Biosensor = () => {
    ...
    return (
        <animated.div className="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column font-link" style={fadeIn}>
            ...
            <OldB />
            <h1 className="mb-4" style={{ paddingTop: "20px" }}>Links</h1>
            <ul>
                <li>
                    <a href="/Chip">Field Emissions Chip Generator</a>
                </li>
                <li>
                    <a href="https://nanotech.onrender.com/" target="_blank">Nano-integrated Technology Research Operations (NiTRO)</a>
                </li>
            </ul>
        </animated.div >
    );
