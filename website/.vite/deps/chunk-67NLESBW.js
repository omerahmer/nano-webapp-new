...
import {
  ...
  useUncontrolled,
  useWindowEvent
} from "./chunk-54UUP7EM.js";
import {
  __toESM,
  require_react
} from "./chunk-UX42DLI7.js";
...
function useHover(context, props) {
  ...
  const timeoutRef = React39.useRef(-1);
  const handlerRef = React39.useRef();
  const restTimeoutRef = React39.useRef(-1);
...
function useFloatingRootContext(options) {
  ...
  const [events] = React39.useState(() => createPubSub());
  ...
  const [positionReference, setPositionReference] = React39.useState(elementsProp.reference);
...
var RingProgress = factory((_props, ref) => {
  ...
  const curves = getCurves({
    ...
    rootColor
  }).map(({ data, sum, root, lineRoundCaps, offset: offset3 }, index5) => import_react315.default.createElement(
    Curve,
    {
      ...data,
      key: index5,
...
tabbable/dist/index.esm.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-67NLESBW.js.map
